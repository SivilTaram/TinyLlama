export WANDB_PROJECT=TinyLLama-English-Distribution
export WANDB_ENTITY=SivilTaram
export WANDB_API_KEY=c5e9b1a784400b81d8ce5537a23ee47f6d034783
export MODEL_NAME=tinyllama_1T_cc100_nodedup_trial_nowarmup_n12
...
lightning run model \
    ...
    pretrain/tinyllama_origin.py --devices $NUMBER_OF_GPU \
