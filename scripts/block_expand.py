...
def main():
    ...
    parser.add_argument("--model_path", default='../../models/tinyllama_120M_mistral_en', type=str, help="original model path")
    parser.add_argument("--output_path", default='pytorch_model.bin', type=str, help="deepened model ckpt save path")
    parser.add_argument("--original_layers", default=12, type=int, help="original model num layers")
    parser.add_argument("--layers", default=24, type=int, help="deepen model num layers")
