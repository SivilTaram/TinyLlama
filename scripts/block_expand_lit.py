...
def main():
    ...
    parser.add_argument("--model_path", default='../../models/TinyLlama-3T-Model', type=str, help="original model path")
    parser.add_argument("--output_path", default='pytorch_model.bin', type=str, help="deepened model ckpt save path")
    parser.add_argument("--original_layers", default=22, type=int, help="original model num layers")
