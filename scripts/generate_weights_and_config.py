...
def generate_train_group(weights, sample_folder=None):
    groups = ['train_data_mixture_en_redpajama', 'train_data_mixture_cleaned_cc100_ind_dedup', 'train_data_mixture_cleaned_cc100_lao_dedup', 'train_data_mixture_cleaned_cc100_ms_dedup', 'train_data_mixture_cleaned_cc100_th_dedup', 'train_data_mixture_cleaned_cc100_vi_dedup', 'train_data_mixture_ebook_id_non_ocr', 
            ...
            #   'train_data_mixture_indonesian_sft_pretrain', 
              'train_data_mixture_malay_madlad', 'train_data_mixture_subtitle_id', 'train_data_mixture_subtitle_th', 'train_data_mixture_subtitle_vi', 'train_data_mixture_thai_madlad',
            #   'train_data_mixture_thai_sft_pretrain', 
              'train_data_mixture_translation_indonesian', 'train_data_mixture_translation_thai', 'train_data_mixture_translation_vietnamese', 'train_data_mixture_vietnamese_madlad', 'train_data_mixture_vietnamese_sft_pretrain', 'train_data_mixture_wikipedia_id_text', 'train_data_mixture_wikipedia_th_text', 'train_data_mixture_wikipedia_vi_text']
...
def generate_valid_group(sample_folder=None):
    groups = ["en_redpajama",
            ...
            "th_wikipedia",
            "vi_wikipedia",
            # all test does not include subtitle
            "all_test"]
...
if __name__ == "__main__":
    output_paths = []
    for i in range(50):
        output_paths.append(f"../sea_config/n{i}.yaml")
    generate_config(output_paths)
